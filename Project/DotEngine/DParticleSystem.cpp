	...
	, m_MaxParticeCount(1000)
{
	...
	// Setting Particle Function (Module) Information
	// Spawn Module
...
void DParticleSystem::CaculateSpawnCount()
{
	...
	{
		// Number of particles to be generated by this tick according to SpawnRate
