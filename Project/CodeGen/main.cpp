...
int main()
{
	...
	wstring strCppPath = strProjPath + L"\\Scripts\\DScriptMgr.cpp";
	wstring strHeaderPath = strProjPath + L"\\Scripts\\DScriptMgr.h";
	...
	fwprintf_s(pFile, L"class DScript;\n\n");

	fwprintf_s(pFile, L"class DScriptMgr\n{\n");
	fwprintf_s(pFile, L"public:\n\tstatic void GetScriptInfo(vector<wstring>& _vec);\n");
	fwprintf_s(pFile, L"\tstatic DScript * GetScript(const wstring& _strScriptName);\n");
	fwprintf_s(pFile, L"\tstatic DScript * GetScript(UINT _iScriptType);\n");
	fwprintf_s(pFile, L"\tstatic const wchar_t * GetScriptName(DScript * _pScript);\n};\n");
	...
	fwprintf_s(pFile, L"#include \"DScriptMgr.h\"\n\n");
	...
	// 두번째 함수 작성
	fwprintf_s(pFile, L"DScript * DScriptMgr::GetScript(const wstring& _strScriptName)\n{\n");
	...
	// 세번째 함수
	fwprintf_s(pFile, L"DScript * DScriptMgr::GetScript(UINT _iScriptType)\n{\n");
	...
	// 네번째 함수
	fwprintf_s(pFile, L"const wchar_t * DScriptMgr::GetScriptName(DScript * _pScript)\n{\n");
